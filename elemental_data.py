...
ALL_STATS = {
    ...
    ElementalType.EARTH: ElementalData(health=1000, mana=500, attack=Fraction(10, 10),
                                       defense=Fraction(13, 10), speed=Fraction(8, 10)),
    ElementalType.WIND: ElementalData(health=1000, mana=500, attack=Fraction(10, 10),
                                       defense=Fraction(9, 10), speed=Fraction(12, 10)),
    ElementalType.LIGHTNING: ElementalData(health=1000, mana=500, attack=Fraction(10, 10),
                                      defense=Fraction(8, 10), speed=Fraction(13, 10)),
    ...
    ElementalType.FLORA: ElementalData(health=1000, mana=500, attack=Fraction(9, 10),
                                      defense=Fraction(1, 10), speed=Fraction(12, 10)),
