...
ALL_STATS = {
    ElementalType.FIRE: ElementalData(
        health=1000,
        mana=500,
    ...
    ElementalType.WATER: ElementalData(
        health=1000,
        mana=500,
    ...
    ElementalType.EARTH: ElementalData(
        health=1000,
        mana=500,
    ...
    ElementalType.WIND: ElementalData(
        health=1000,
        mana=500,
        attack=Fraction(10, 10),
        defense=Fraction(9, 10),
    ...
    ElementalType.LIGHTNING: ElementalData(
        health=1000,
        mana=500,
        attack=Fraction(11, 10),
    ...
    ElementalType.MAGMA: ElementalData(
        health=1000,
        mana=500,
    ...
    ElementalType.SMOKE: ElementalData(
        health=1000,
        mana=500,
    ...
    ElementalType.PLASMA: ElementalData(
        health=1000,
        mana=500,
    ...
    ElementalType.STEAM: ElementalData(
        health=1000,
        mana=500,
        attack=Fraction(10, 10),
        defense=Fraction(12, 10),
    ...
    ElementalType.SAND: ElementalData(
        health=1000,
        mana=500,
        attack=Fraction(10, 10),
    ...
    ElementalType.THUNDER: ElementalData(
        health=1000,
        mana=500,
        attack=Fraction(11, 10),
        defense=Fraction(11, 10),
    ...
    ElementalType.ICE: ElementalData(
        health=1000,
        mana=500,
        attack=Fraction(13, 10),
    ...
    ElementalType.CRYSTAL: ElementalData(
        health=1000,
        mana=500,
    ...
    ElementalType.FLORA: ElementalData(
        health=1000,
        mana=500,
        attack=Fraction(9, 10),
        defense=Fraction(11, 10),
    ...
    ElementalType.STORM: ElementalData(
        health=1000,
        mana=500,
        attack=Fraction(13, 10),
        defense=Fraction(11, 10),
